...
<div class="container">
    <div class="footer" id="footer">
        ...
        <div class="column" id="product-categories">
            ...
            <ul>
                <li><a href="products?category=Giải trí" target="_top">Giải trí</a></li>
                <li><a href="products?category=Học tập" target="_top">Học tập</a></li>
                <li><a href="products?category=Làm việc" target="_top">Làm việc</a></li>
                <li><a href="products?category=Tiện ích" target="_top">Tiện ích</a></li>
                <li><a href="products?category=Bảo mật" target="_top">Bảo mật</a></li>
                <li><a href="products?category=Lữu trữ" target="_top">Lưu trữ</a></li>
            </ul>
        </div>
        ...
        <div class="column" id="account">
            <h3>TÀI KHOẢN</h3>
            <ul>
                <li><a href="Cart" target="_top">Giỏ hàng</a></li>
                <li><a href="taikhoan.jsp" target="_top">Trang cá nhân</a></li>
            </ul>
        </div>
